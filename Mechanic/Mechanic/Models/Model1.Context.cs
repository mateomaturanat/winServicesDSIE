...
namespace Mechanic.Models
{
    ...
    public partial class ProyectoDelCursoEntities : DbContext
    {
        public ProyectoDelCursoEntities()
            : base("name=ProyectoDelCursoEntities")
        {
        }
        ...
        public virtual int updateMechanic(Nullable<int> idMechanic, string nameMechanic, string surnameMechanic, string identMechanic, string genderMechanic, string phoneMechanic, byte[] profilePictureMechanic, string latitude, string longitude, Nullable<int> idcity, Nullable<int> idTypeDocument)
        {
            var idMechanicParameter = idMechanic.HasValue ?
                new ObjectParameter("idMechanic", idMechanic) :
                new ObjectParameter("idMechanic", typeof(int));
